...
def rename(checkpoint_dir, replace_from, replace_to, add_prefix, dry_run):
    ...
    with tf.Session() as sess:
        ...
        model_checkpoint_path = './Checkpoint-0/ckpt_crop_16_16'   #1
        if not dry_run:
            # Save the variables
...
def main(argv):
    checkpoint_dir = './Checkpoint/ckpt_crop_16_16'    #2
    replace_from = 'classifier'
    replace_to = 'classifier_8'     #3
    add_prefix = None
    dry_run = False
#[(10, 10), (10, 13), (10, 16), (13, 10), (13, 13), (13, 16), (16, 10), (16, 13), (16, 16)]
